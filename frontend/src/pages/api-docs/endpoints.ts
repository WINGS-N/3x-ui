...
export const sections: readonly Section[] = [
        ...
        params: [
          {
            ...
            in: "body",
            type: "string",
            desc: "Panel admin username.",
          },
          {
            name: "password",
            in: "body",
            type: "string",
            desc: "Panel admin password.",
          },
          {
            name: "twoFactorCode",
            in: "body",
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary:
          "List the wireguard peers available for binding a vk-turn-proxy client when the inbound forwards into a wireguard inbound.",
        params: [
          {
            name: "id",
            in: "path",
            type: "number",
            desc: "vk-turn-proxy inbound ID.",
          },
        ],
      },
      {
        method: "GET",
        path: "/panel/api/inbounds/:id/wireguard/allowedIpConflicts",
        summary:
          "List duplicate allowedIP conflicts (the 10.0.0.X/32 pool) among a wireguard inbound's peers so the UI can offer an auto-fix.",
        params: [
          {
            name: "id",
            in: "path",
            type: "number",
            desc: "WireGuard inbound ID.",
          },
        ],
      },
      {
        method: "POST",
        path: "/panel/api/inbounds/:id/wireguard/fixAllowedIpConflicts",
        summary:
          "Reassign each duplicate 10.0.0.X/32 allowedIP in a wireguard inbound to a fresh unique address, re-sync any bound vk-turn-proxy client, and return the peers that were changed.",
        params: [
          {
            name: "id",
            in: "path",
      ...
      },
      {
        ...
        summary:
          "Build the wingsv:// config link for a single vk-turn-proxy client. Honours forwarded headers only from a trusted proxy.",
        params: [
          {
            name: "id",
            in: "path",
      ...
      },
      {
        ...
        summary:
          "Build wingsv:// config links for every enabled vk-turn-proxy client of the inbound.",
        params: [
          {
            name: "id",
            in: "path",
      ...
      },
      {
        ...
        summary:
          "Toggle a single vk-turn-proxy client on or off without resending the whole settings JSON. Disabling pulls the client peer from the target wireguard inbound while keeping its reserved address.",
        params: [
          {
            name: "id",
            in: "path",
...

  {
    ...
    endpoints: [
        ...
        params: [
          {
            ...
            in: "path",
            type: "number",
            desc: "Number of trailing log lines.",
          },
        ],
        body: '{\n  "level": "info",\n  "syslog": false\n}',
        response:
      ...
      },
      {
        ...
        summary:
          "Return the last N vk-turn-proxy log lines (newest first), tailed from the end of the panel log so large logs stay fast.",
        params: [
          {
            name: "count",
            in: "path",
          ...
          },
          {
            ...
            in: "body (form)",
            type: "string",
            desc: "Maximum log level to include (error, warning, notice, info, debug).",
          },
        ],
      },
      {
        ...
        summary:
          "Return the vk-turn-proxy runtime status (state, running count, installed version).",
      },
      {
        method: "GET",
        path: "/panel/api/server/vk-turn-proxy/versions",
        summary:
          "List the vk-turn-proxy binary release tags available for install (cached).",
      },
      {
        method: "POST",
        path: "/panel/api/server/vk-turn-proxy/start",
        summary:
          "Start the vk-turn-proxy sidecar for every enabled vk-turn-proxy inbound.",
      },
      {
        method: "POST",
      ...
      },
      {
        ...
        summary:
          "Download and install the given vk-turn-proxy release tag, then restart the sidecar.",
        params: [
          {
            name: "version",
            in: "path",
            type: "string",
            desc: 'Release tag to install, or "latest".',
          },
        ],
      },
      {
        ...
        summary:
          'Upload a custom vk-turn-proxy binary (multipart form field "binary") and install it.',
      },
      {
        method: "POST",
        ...
        params: [
          {
            ...
            in: "body (multipart)",
            type: "file",
            desc: "SQLite database file to upload.",
          },
        ],
      },
      {
...

  {
    ...
    endpoints: [
        ...
        params: [
          {
            ...
            in: "body (json)",
            type: "object",
            desc: "Client fields: email, subId, id (uuid), password, auth, flow, totalGB, expiryTime, limitIp, tgId (numeric Telegram user ID, 0 = none), comment, enable.",
          },
          {
            name: "inboundIds",
            in: "body (json)",
      ...
      },
      {
        ...
        summary:
          "Replace a client's external links (per-client share links and remote subscription URLs surfaced in their subscription). Sends the full set; the server replaces all rows.",
        params: [
          {
            name: "email",
            in: "path",
          ...
          },
          {
            ...
            in: "body (json)",
            type: "object[]",
            desc: 'Rows of { kind: "link" | "subscription", value, remark }. kind=link must be a share link; kind=subscription must be an http(s) URL.',
          },
        ],
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        params: [{ name: "id", in: "path", type: "number", desc: "Host ID." }],
        responseSchema: "Host",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            in: "body",
            type: "string",
            desc: "Desired new username.",
          },
          {
            name: "newPassword",
            in: "body",
            type: "string",
            desc: "Desired new password.",
          },
        ],
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            in: "body (form)",
            type: "string",
            desc: '"tcp" for a fast dial-only probe (parallel-safe). Default/empty uses a full HTTP probe through a temp xray instance.',
          },
        ],
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            in: "body (form)",
            type: "string",
            desc: '"tcp" for fast dial-only probes (UDP-transport outbounds are still probed over HTTP). Default/empty routes a real HTTP request through each outbound.',
          },
        ],
...

  {
    ...
    subHeader: [
      ...
      {
        name: "Profile-Title",
        desc: "Base64-encoded subscription display name",
      },
      {
        name: "Profile-Web-Page-Url",
        desc: "Link to the subscription info page",
      },
      {
        name: "Support-Url",
        desc: "Support contact URL configured in settings",
      },
      {
