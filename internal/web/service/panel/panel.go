...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/WINGS-N/3x-ui/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/WINGS-N/3x-ui/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/WINGS-N/3x-ui/releases/tags/" + tag
	}
