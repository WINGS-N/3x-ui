...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/WINGS-N/3x-ui/main/x-ui.sh
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/WINGS-N/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
